...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(floyd.config.endpoints);

    var serviceConfig = $.extend(true, {}, floyd.config.services, {
        db: {
    ...
    floyd.db = new DevExpress.data.ODataContext(serviceConfig.db);
